...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post descriptions_url, params: { description: { content: @description.content, name: @description.name } }
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { content: @description.content, name: @description.name } }
